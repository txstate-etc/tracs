...
//	spring service injection
	...
	{
		return "From: " + "\"" + m_serverConfigurationService.getString("ui.service", "Sakai") + "\" <"+  m_serverConfigurationService.getString("email.noreply_address", "no-reply@" + m_serverConfigurationService.getServerName()) + ">";
	}
