...
<!--jsp/discussionForum/forum/dfForumSettings.jsp-->
        ...
        <h:outputText styleClass="messageAlert" value="#{msgs.cdfm_delete_forum} " rendered="#{ForumTool.selectedForum.markForDeletion && ForumTool.selectedForum.forum.defaultAssignName==null}" style="display:block" />
        <h:outputText styleClass="messageAlert" value="#{msgs.cdfm_delete_forum_warning}" rendered="#{ForumTool.selectedForum.markForDeletion && ForumTool.selectedForum.forum.defaultAssignName!=null}" style="display:block" />
