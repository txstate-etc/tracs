...
public class CancelMeetingEmail extends AllUsersEmailBase {
	...
	public List<String> getHeader() {
		...
		rv.add("To: " + getSakaiFacade().getServerConfigurationService().getString("email.noreply_address","no-reply@" + getSakaiFacade().getServerConfigurationService().getServerName()));
