...
abstract public class SignupEmailBase implements SignupEmailNotification, MeetingTypes {
	...
	protected String getServerFromAddress() {
		return  getServiceName() +" <" + getSakaiFacade().getServerConfigurationService().getString("email.noreply_address", "no-reply@"  + getSakaiFacade().getServerConfigurationService().getServerName())+ ">";
	}
